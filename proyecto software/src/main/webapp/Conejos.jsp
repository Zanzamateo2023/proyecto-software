<%-- 
    Document   : Conejos
    Created on : 24/09/2024, 8:00:36 p. m.
    Author     : Alejandro
--%>
...
<body>
    ...
    <h2>
        <form class="formulario"></form>
            <fieldset>
                <legend>Aca podras reportar a tu conejo dandonos sus caracteristicas, nombre, entre otros</legend>
            ...
            <input class="boton" type="submit" value="Subir foto del conejo">
        </form>
    </h2>
        <style>
body{
